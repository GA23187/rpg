...
public class Enemy
{
    ...
    public void set(string name, string fbitmap_path, int fx_offset, int fy_offset, int maxhp,int attack,int defense,int fspeed,int fortune, Animation anm_att,  Animation anm_skill,int[] fightlist)
    {
        this.name = name;
